...
def run(experiment, ordered_supported_parameters, root, resonances, meas, if_band, num_pts, widths, pwrs, time_one_sweep, waits=None,avg_number=None, ip_addr='169.254.252.66'):
    ...
    try:
        ...
        for power in pwrs:
            ...
            for resonance in resonances:
                ...
                experiment.make_fit(pool, freq_num, dataComplex, [resonance, power])
